...
impl WithdrawalServiceImpl {
    pub fn new(withdrawal_service: Arc<WithdrawalDomainService>, wallet_service: Arc<WalletService>) -> Self {
        Self { withdrawal_service, wallet_service }
    }
}
...
impl WithdrawalService for WithdrawalServiceImpl {
    async fn create_withdrawal(
        ...
        let wallet = self.wallet_service
    ...
    async fn cancel_withdrawal(
        ...
        let withdrawal = self.withdrawal_service
