...
type Membership struct {
	...
	Avatars   string   `protobuf:"bytes,7,opt,name=avatars,proto3" json:"avatars,omitempty"` // JSON string
...
func (x *Membership) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *Membership) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *Membership) GetAvatars() string {
	if x != nil {
		return x.Avatars
	}
	return ""
...
var file_common_membership_proto_rawDesc = []byte{
	...
	0x68, 0x69, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x22, 0xb1, 0x02, 0x0a, 0x0a, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70,
	...
	0x18, 0x0a, 0x07, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x6f, 0x6c,
...
var file_common_membership_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_membership_proto_goTypes = []interface{}{
	(*Membership)(nil), // 0: common.Membership
}
