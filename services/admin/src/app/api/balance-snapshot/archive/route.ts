...
import { balanceSnapshotArchiveManyController } from 'src/features/balanceSnapshot/controllers/balanceSnapshotArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await balanceSnapshotArchiveManyController(query, context);
    const payload = true;
