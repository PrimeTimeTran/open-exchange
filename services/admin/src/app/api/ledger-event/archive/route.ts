...
import { ledgerEventArchiveManyController } from 'src/features/ledgerEvent/controllers/ledgerEventArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await ledgerEventArchiveManyController(query, context);
    const payload = true;
