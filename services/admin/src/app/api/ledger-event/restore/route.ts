...
import { ledgerEventRestoreManyController } from 'src/features/ledgerEvent/controllers/ledgerEventRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await ledgerEventRestoreManyController(query, context);
    const payload = true;
