...
import { feedbackRestoreManyController } from 'src/features/feedback/controllers/feedbackRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await feedbackRestoreManyController(query, context);
    const payload = true;
