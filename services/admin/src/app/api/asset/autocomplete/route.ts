...
import { assetAutocompleteController } from 'src/features/asset/controllers/assetAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await assetAutocompleteController(query, context);
