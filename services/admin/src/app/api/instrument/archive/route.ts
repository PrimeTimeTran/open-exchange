...
import { instrumentArchiveManyController } from 'src/features/instrument/controllers/instrumentArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await instrumentArchiveManyController(query, context);
    const payload = true;
