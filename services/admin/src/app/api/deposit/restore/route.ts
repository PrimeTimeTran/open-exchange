...
import { depositRestoreManyController } from 'src/features/deposit/controllers/depositRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await depositRestoreManyController(query, context);
    const payload = true;
