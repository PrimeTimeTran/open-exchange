...
import { withdrawalRestoreManyController } from 'src/features/withdrawal/controllers/withdrawalRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await withdrawalRestoreManyController(query, context);
    const payload = true;
