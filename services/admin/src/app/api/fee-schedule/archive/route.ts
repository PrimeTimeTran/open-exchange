...
import { feeScheduleArchiveManyController } from 'src/features/feeSchedule/controllers/feeScheduleArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await feeScheduleArchiveManyController(query, context);
    const payload = true;
