...
export function InstrumentAutocompleteInput({
  onChange,
  value,
  selectPlaceholder,
  searchPlaceholder,
  ...
  onChange: (value: Partial<Instrument> | undefined | null) => void;
  value?: Partial<Instrument> | null;
    ...
    <div className="flex w-full gap-1">
      ...
      {isFormOpen && (
        <InstrumentFormSheet
          ...
          context={context}
          instrument={value ? value : undefined}
        />
      )}
    </div>
  );
