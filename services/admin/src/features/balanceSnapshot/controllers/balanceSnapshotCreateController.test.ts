...
describe('balanceSnapshotCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await balanceSnapshotCreateController(body, await testContext());
      fail();
    } catch (error) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await balanceSnapshotCreateController(
        body,
        await testContext({
