...
import { chatUpdateController } from 'src/features/chat/controllers/chatUpdateController';
...
describe('chatUpdate', () => {
  ...
  //     const previousChat = await createChat(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
