...
import { chateeImporterController } from 'src/features/chatee/controllers/chateeImporterController';
...
async function buildChatee(context: AppContext) {
...
describe('chateeImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await chateeImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await chateeImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await chateeImporterController(
