/*
  ...
  - Added the required column `feeCurrency` to the `Fill` table without a default value. This is not possible if the table is not empty.
  - Added the required column `instrumentId` to the `Fill` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `role` to the `Fill` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Fill" ADD COLUMN     "feeCurrency" TEXT NOT NULL,
ADD COLUMN     "instrumentId" UUID NOT NULL,
ADD COLUMN     "orderId" UUID NOT NULL,
ADD COLUMN     "role" TEXT NOT NULL,
ALTER COLUMN "tenantId" SET DEFAULT NULLIF((current_setting('app.current_tenant_id'::text)), '')::uuid,
ALTER COLUMN "createdByUserId" SET DEFAULT NULLIF((current_setting('app.current_user_id'::text)), '')::uuid,
ALTER COLUMN "createdByMembershipId" SET DEFAULT NULLIF((current_setting('app.current_membership_id'::text)), '')::uuid,
ALTER COLUMN "updatedByUserId" SET DEFAULT NULLIF((current_setting('app.current_user_id'::text)), '')::uuid,
ALTER COLUMN "updatedByMembershipId" SET DEFAULT NULLIF((current_setting('app.current_membership_id'::text)), '')::uuid;
