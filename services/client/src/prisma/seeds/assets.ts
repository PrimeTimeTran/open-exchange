...
export async function seedAssets(
  ...
  const assetsData = [
    ...
    { symbol: 'META', name: 'Meta', klass: 'stock', decimals: 2 },
    { symbol: 'AAPL', name: 'Apple', klass: 'stock', decimals: 2 },
    { symbol: 'TSLA', name: 'Tesla', klass: 'stock', decimals: 2 },
    { symbol: 'GOOGL', name: 'Google', klass: 'stock', decimals: 2 },
    { symbol: 'MSFT', name: 'Microsoft', klass: 'stock', decimals: 2 },
