...
export interface LedgerEvent {
  ...
  type?:
    | string
    | undefined;
  /** ID of the object causing the event (order_id, deposit_id) */
...
export const LedgerEvent: MessageFns<LedgerEvent> = {
  encode(message: LedgerEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.referenceType !== undefined && message.referenceType !== "") {
      writer.uint32(42).string(message.referenceType);
    }
  ...
  fromJSON(object: any): LedgerEvent {
    return {
      ...
      referenceType: isSet(object.referenceType)
        ? globalThis.String(object.referenceType)
        : isSet(object.reference_type)
        ? globalThis.String(object.reference_type)
        : "",
