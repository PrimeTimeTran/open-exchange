...
import { tradeAutocompleteController } from 'src/features/trade/controllers/tradeAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await tradeAutocompleteController(query, context);
