...
import { candidateArchiveManyController } from 'src/features/candidate/controllers/candidateArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await candidateArchiveManyController(query, context);
    const payload = true;
