...
import { candidateRestoreManyController } from 'src/features/candidate/controllers/candidateRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await candidateRestoreManyController(query, context);
    const payload = true;
