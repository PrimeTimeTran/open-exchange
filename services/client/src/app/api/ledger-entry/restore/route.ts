...
import { ledgerEntryRestoreManyController } from 'src/features/ledgerEntry/controllers/ledgerEntryRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await ledgerEntryRestoreManyController(query, context);
    const payload = true;
