...
import { marketMakerArchiveManyController } from 'src/features/marketMaker/controllers/marketMakerArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await marketMakerArchiveManyController(query, context);
    const payload = true;
