...
import { marketMakerRestoreManyController } from 'src/features/marketMaker/controllers/marketMakerRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await marketMakerRestoreManyController(query, context);
    const payload = true;
