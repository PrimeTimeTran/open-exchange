...
import { commentArchiveManyController } from 'src/features/comment/controllers/commentArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await commentArchiveManyController(query, context);
    const payload = true;
