...
import { userNotificationArchiveManyController } from 'src/features/userNotification/controllers/userNotificationArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await userNotificationArchiveManyController(query, context);
    const payload = true;
