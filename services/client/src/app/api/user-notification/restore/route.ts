...
import { userNotificationRestoreManyController } from 'src/features/userNotification/controllers/userNotificationRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await userNotificationRestoreManyController(query, context);
    const payload = true;
