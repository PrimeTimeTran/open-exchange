...
import { articleRestoreManyController } from 'src/features/article/controllers/articleRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await articleRestoreManyController(query, context);
    const payload = true;
