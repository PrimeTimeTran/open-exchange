...
import { feedbackArchiveManyController } from 'src/features/feedback/controllers/feedbackArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await feedbackArchiveManyController(query, context);
    const payload = true;
