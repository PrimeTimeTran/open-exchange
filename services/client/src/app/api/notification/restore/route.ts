...
import { notificationRestoreManyController } from 'src/features/notification/controllers/notificationRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await notificationRestoreManyController(query, context);
    const payload = true;
