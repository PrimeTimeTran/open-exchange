...
import { messageRestoreManyController } from 'src/features/message/controllers/messageRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await messageRestoreManyController(query, context);
    const payload = true;
