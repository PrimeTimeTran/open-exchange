...
import { messageArchiveManyController } from 'src/features/message/controllers/messageArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await messageArchiveManyController(query, context);
    const payload = true;
