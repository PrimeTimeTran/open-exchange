...
import { feeScheduleRestoreManyController } from 'src/features/feeSchedule/controllers/feeScheduleRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await feeScheduleRestoreManyController(query, context);
    const payload = true;
