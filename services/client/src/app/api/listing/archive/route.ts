...
import { listingArchiveManyController } from 'src/features/listing/controllers/listingArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await listingArchiveManyController(query, context);
    const payload = true;
