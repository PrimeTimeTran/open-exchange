...
import { listingRestoreManyController } from 'src/features/listing/controllers/listingRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await listingRestoreManyController(query, context);
    const payload = true;
