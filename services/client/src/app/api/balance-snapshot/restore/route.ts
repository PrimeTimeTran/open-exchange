...
import { balanceSnapshotRestoreManyController } from 'src/features/balanceSnapshot/controllers/balanceSnapshotRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await balanceSnapshotRestoreManyController(query, context);
    const payload = true;
