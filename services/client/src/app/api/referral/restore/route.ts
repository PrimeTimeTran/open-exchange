...
import { referralRestoreManyController } from 'src/features/referral/controllers/referralRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await referralRestoreManyController(query, context);
    const payload = true;
