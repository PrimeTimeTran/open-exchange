...
import { instrumentRestoreManyController } from 'src/features/instrument/controllers/instrumentRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await instrumentRestoreManyController(query, context);
    const payload = true;
