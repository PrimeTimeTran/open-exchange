const dictionary = {
  ...
  marketMaker: {
    ...
    list: {
      menu: 'MarketMakers',
      title: 'MarketMakers',
      noResults: 'No marketmakers found.',
    },

    export: {
      success: 'MarketMakers successfully exported',
    },

    new: {
      menu: 'New MarketMaker',
      title: 'New MarketMaker',
      success: 'MarketMaker successfully created',
    },

    view: {
      title: 'View MarketMaker',
    },

    edit: {
      menu: 'Edit MarketMaker',
      title: 'Edit MarketMaker',
      success: 'MarketMaker successfully updated',
    },

    restore: {
      success: 'MarketMaker successfully restored',
      noSelection: 'You must select at least one marketmaker to restore.',
      confirmTitle: 'Restore MarketMaker?',
    },

    restoreMany: {
      success: 'MarketMaker(s) successfully restored',
      noSelection: 'You must select at least one marketmaker to restore.',
      confirmTitle: 'Restore MarketMaker(s)?',
      confirmDescription:
        'Are you sure you want to restore the {0} selected marketmaker(s)?',
    },

    archiveMany: {
      success: 'MarketMaker(s) successfully archived',
      noSelection: 'You must select at least one marketmaker to archive.',
      confirmTitle: 'Archive MarketMaker(s)?',
      confirmDescription:
        'Are you sure you want to archive the {0} selected marketmaker(s)?',
    },

    archive: {
      success: 'MarketMaker successfully archived',
      noSelection: 'You must select at least one marketmaker to archive.',
      confirmTitle: 'Archive MarketMaker?',
    },

    destroyMany: {
      success: 'MarketMaker(s) successfully deleted',
      noSelection: 'You must select at least one marketmaker to delete.',
      confirmTitle: 'Delete MarketMaker(s)?',
      confirmDescription:
        'Are you sure you want to delete the {0} selected marketmaker(s)?',
    },

    destroy: {
      success: 'MarketMaker successfully deleted',
      noSelection: 'You must select at least one marketmaker to delete.',
      confirmTitle: 'Delete MarketMaker?',
    },
