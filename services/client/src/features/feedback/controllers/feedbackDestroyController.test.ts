...
import { feedbackDestroyManyController } from 'src/features/feedback/controllers/feedbackDestroyManyController';
...
describe('feedbackDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await feedbackDestroyManyController(
        {
          ids: [feedback?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.feedback.count();
    ...
    const countAfterDelete = await prisma.feedback.count();
