...
describe('userNotificationUpdate', () => {
  ...
  it.skip('must be signed in', async () => {
    ...
    try {
      await userNotificationUpdateController(
  ...
  //     const previousUserNotification = await createUserNotification(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     await userNotificationUpdateController(
  //       { id: previousUserNotification?.id },
  ...
  //     const updatedUserNotification = await prisma.userNotification.findUniqueOrThrow({
  //       where: { id: previousUserNotification?.id },
  //       include: {},
  //     });
