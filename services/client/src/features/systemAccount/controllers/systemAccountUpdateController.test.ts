...
describe('systemAccountUpdate', () => {
  ...
  it.skip('must be signed in', async () => {
    ...
    try {
      await systemAccountUpdateController(
        { id: systemAccount.id },
        {},
        await testContext(),
      );
  ...
  //     const previousSystemAccount = await createSystemAccount(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     const updatedSystemAccount = await prisma.systemAccount.findUniqueOrThrow({
  //       where: { id: previousSystemAccount?.id },
  //       include: {},
  //     });

  //     expect({
  //       ...previousSystemAccount,
