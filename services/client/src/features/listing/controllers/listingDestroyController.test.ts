...
describe('listingDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await listingDestroyManyController(
        {
          ids: [listing?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.listing.count();
    ...
    const countAfterDelete = await prisma.listing.count();
