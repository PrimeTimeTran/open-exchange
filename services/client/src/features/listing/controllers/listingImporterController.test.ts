...
import { listingImporterController } from 'src/features/listing/controllers/listingImporterController';
...
async function buildListing(context: AppContext) {
...
describe('listingImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await listingImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await listingImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await listingImporterController(
