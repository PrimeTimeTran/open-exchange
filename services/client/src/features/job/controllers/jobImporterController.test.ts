...
import { jobImporterController } from 'src/features/job/controllers/jobImporterController';
...
async function buildJob(context: AppContext) {
...
describe('jobImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await jobImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await jobImporterController(
