...
import { jobDestroyManyApiCall, jobArchiveManyApiCall, jobRestoreManyApiCall } from 'src/features/job/jobApiCalls';
        ...
        <DropdownMenuContent align="end" className="w-[160px]">
          {mode === 'table' && (
            <DropdownMenuItem asChild>
              <Link href={`/job/${job.id}`} prefetch={false}>
          ...
          {mode === 'table' && hasPermissionToEdit && (
            <DropdownMenuItem asChild>
              <Link href={`/job/${job.id}/edit`} prefetch={false}>
