...
import { articleImporterController } from 'src/features/article/controllers/articleImporterController';
...
async function buildArticle(context: AppContext) {
...
describe('articleImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await articleImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await articleImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await articleImporterController(
