...
describe('instrumentDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await instrumentDestroyManyController(
        {
          ids: [instrument?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.instrument.count();
    ...
    const countAfterDelete = await prisma.instrument.count();
