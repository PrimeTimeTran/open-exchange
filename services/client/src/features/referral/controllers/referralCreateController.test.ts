...
import { referralCreateController } from 'src/features/referral/controllers/referralCreateController';
...
describe('referralCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await referralCreateController(body, await testContext());
      fail();
    } catch (error) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await referralCreateController(
        body,
        await testContext({
