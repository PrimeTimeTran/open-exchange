...
export default function ReferralListActions({
  ...
  const hasPermissionToCreate = hasPermission(permissions.referralCreate, context);
  ...
  const hasPermissionToImport = hasPermission(permissions.referralImport, context);
