...
import { referralFilterFormSchema } from 'src/features/referral/referralSchemas';
...
function ReferralListFilter({
  ...
  const previewRenders = {
    referrerUserId: {
      label: dictionary.referral.fields.referrerUserId,
    },
    referredUserId: {
      label: dictionary.referral.fields.referredUserId,
    },
    referralCode: {
      label: dictionary.referral.fields.referralCode,
    },
    source: {
      label: dictionary.referral.fields.source,
      render: dataTableFilterRenders(context).enumerator(
        dictionary.referral.enumerators.source,
      ),
    },
    status: {
      label: dictionary.referral.fields.status,
      render: dataTableFilterRenders(context).enumerator(
        dictionary.referral.enumerators.status,
      ),
    },
    rewardType: {
      label: dictionary.referral.fields.rewardType,
      render: dataTableFilterRenders(context).enumerator(
    ...
    rewardedAtRange: {
      label: dictionary.referral.fields.rewardedAt,
  ...
  const filter = useMemo(
    () =>
      DataTableQueryParams.getFilter<z.infer<typeof referralFilterFormSchema>>(
        searchParams,
        referralFilterFormSchema,
      ),
    [searchParams],
  );

  const form = useForm({
    resolver: zodResolver(referralFilterFormSchema),
    mode: 'onSubmit',
  ...
  useEffect(() => {
    form.reset({ ...emptyValues, ...filter } as z.infer<
      typeof referralFilterFormSchema
    >);
  }, [filter, form]);
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{dictionary.referral.fields.referrerUserId}</FormLabel>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{dictionary.referral.fields.referredUserId}</FormLabel>
                    <Input disabled={isLoading} {...field} />
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{dictionary.referral.fields.referralCode}</FormLabel>
                    <Input disabled={isLoading} {...field} />
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <SelectInput
                      options={Object.keys(referralEnumerators.status).map(
                        (value) => ({
                          value,
                          label: enumeratorLabel(
                            dictionary.referral.enumerators.status,
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <SelectInput
                      options={Object.keys(referralEnumerators.rewardType).map(
                        (value) => ({
                          value,
                          label: enumeratorLabel(
                            dictionary.referral.enumerators.rewardType,
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{dictionary.referral.fields.rewardCurrency}</FormLabel>
                    <Input disabled={isLoading} {...field} />
                    <FormMessage />
                  </FormItem>
                )}
...
export default ReferralListFilter;
