...
import { candidateCreateController } from 'src/features/candidate/controllers/candidateCreateController';
...
describe('candidateCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await candidateCreateController(body, await testContext());
      fail();
    } catch (error) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await candidateCreateController(
        body,
        await testContext({
