...
export default function CandidateListActions({
  ...
  const hasPermissionToCreate = hasPermission(permissions.candidateCreate, context);
  ...
  const hasPermissionToImport = hasPermission(permissions.candidateImport, context);
