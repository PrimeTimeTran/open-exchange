...
import { PasswordResetConfirmFormWithRecaptcha } from 'src/features/auth/components/PasswordResetConfirmForm';
...
export async function generateMetadata() {
  ...
  return {
    title: dictionary.auth.passwordResetConfirm.title,
  };
}
      ...
      <div className="container relative grid min-h-screen flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          <div
            ...
            style={{
              backgroundImage: 'url(/images/passwordReset.jpg)',
            }}
          />
        </div>
        <div className="w-[100vw] p-4 sm:w-auto md:p-0 lg:p-8">
          <div className="mx-auto flex w-full flex-col justify-center sm:w-[350px]">
            ...
            <PasswordResetConfirmFormWithRecaptcha
              dictionary={dictionary}
              locale={context.locale}
            />
            <Link
              className="mt-4 block text-center text-sm font-medium text-gray-800 hover:underline dark:text-gray-200"
              href="/auth/sign-in"
              prefetch={false}
            >
