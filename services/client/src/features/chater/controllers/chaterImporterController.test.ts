...
import { chaterImporterController } from 'src/features/chater/controllers/chaterImporterController';
...
describe('chaterImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await chaterImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await chaterImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await chaterImporterController(
