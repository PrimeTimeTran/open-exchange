...
import { tradeImporterController } from 'src/features/trade/controllers/tradeImporterController';
...
async function buildTrade(context: AppContext) {
...
describe('tradeImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await tradeImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await tradeImporterController(
