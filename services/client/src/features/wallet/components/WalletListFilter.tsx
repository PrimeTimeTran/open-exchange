...
import { walletFilterFormSchema } from 'src/features/wallet/walletSchemas';
...
function WalletListFilter({
  ...
  const filter = useMemo(
    () =>
      DataTableQueryParams.getFilter<z.infer<typeof walletFilterFormSchema>>(
        searchParams,
        walletFilterFormSchema,
      ),
    [searchParams],
  );

  const form = useForm({
    resolver: zodResolver(walletFilterFormSchema),
    mode: 'onSubmit',
