...
export function NotificationAutocompleteInput({
  onChange,
  value,
  selectPlaceholder,
  searchPlaceholder,
  ...
  onChange: (value: Partial<Notification> | undefined | null) => void;
  value?: Partial<Notification> | null;
    ...
    <div className="flex w-full gap-1">
      ...
      {isFormOpen && (
        <NotificationFormSheet
          ...
          context={context}
          notification={value ? value : undefined}
        />
      )}
    </div>
  );
