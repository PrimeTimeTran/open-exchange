...
import { depositUpdateController } from 'src/features/deposit/controllers/depositUpdateController';
...
describe('depositUpdate', () => {
  ...
  //     const previousDeposit = await createDeposit(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     const updatedDeposit = await prisma.deposit.findUniqueOrThrow({
  //       where: { id: previousDeposit?.id },
  //       include: {},
  //     });
