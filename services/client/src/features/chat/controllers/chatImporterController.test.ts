...
import { chatImporterController } from 'src/features/chat/controllers/chatImporterController';
...
async function buildChat(context: AppContext) {
...
describe('chatImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await chatImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await chatImporterController(
