...
import { tradeFillArchiveManyController } from 'src/features/tradeFill/controllers/tradeFillArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await tradeFillArchiveManyController(query, context);
    const payload = true;
