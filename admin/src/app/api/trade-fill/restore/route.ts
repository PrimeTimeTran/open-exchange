...
import { tradeFillRestoreManyController } from 'src/features/tradeFill/controllers/tradeFillRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await tradeFillRestoreManyController(query, context);
    const payload = true;
