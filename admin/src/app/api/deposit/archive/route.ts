...
import { depositArchiveManyController } from 'src/features/deposit/controllers/depositArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await depositArchiveManyController(query, context);
    const payload = true;
