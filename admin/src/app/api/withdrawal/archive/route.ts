...
import { withdrawalArchiveManyController } from 'src/features/withdrawal/controllers/withdrawalArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await withdrawalArchiveManyController(query, context);
    const payload = true;
