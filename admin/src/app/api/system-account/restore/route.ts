...
import { systemAccountRestoreManyController } from 'src/features/systemAccount/controllers/systemAccountRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await systemAccountRestoreManyController(query, context);
    const payload = true;
