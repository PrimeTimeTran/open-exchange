...
import { systemAccountArchiveManyController } from 'src/features/systemAccount/controllers/systemAccountArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await systemAccountArchiveManyController(query, context);
    const payload = true;
