...
import { articleArchiveManyController } from 'src/features/article/controllers/articleArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await articleArchiveManyController(query, context);
    const payload = true;
