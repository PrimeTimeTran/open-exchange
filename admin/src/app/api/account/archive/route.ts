...
import { accountArchiveManyController } from 'src/features/account/controllers/accountArchiveManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await accountArchiveManyController(query, context);
    const payload = true;
