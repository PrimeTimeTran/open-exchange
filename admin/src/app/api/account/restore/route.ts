...
import { accountRestoreManyController } from 'src/features/account/controllers/accountRestoreManyController';
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await accountRestoreManyController(query, context);
    const payload = true;
