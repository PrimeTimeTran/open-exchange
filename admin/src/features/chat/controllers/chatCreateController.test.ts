...
import { chatCreateController } from 'src/features/chat/controllers/chatCreateController';
...
describe('chatCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await chatCreateController(body, await testContext());
      fail();
    } catch (error) {
