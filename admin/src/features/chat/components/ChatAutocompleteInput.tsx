...
import { chatAutocompleteApiCall } from 'src/features/chat/chatApiCalls';
import { chatLabel } from 'src/features/chat/chatLabel';
import { ChatFormSheet } from 'src/features/chat/components/ChatFormSheet';
...
export function ChatAutocompleteInput({
  onChange,
  value,
  selectPlaceholder,
  searchPlaceholder,
  ...
  onChange: (value: Partial<Chat> | undefined | null) => void;
  value?: Partial<Chat> | null;
  ...
  const queryFn = (
    ...
    return chatAutocompleteApiCall(
      {
        search,
        exclude,
