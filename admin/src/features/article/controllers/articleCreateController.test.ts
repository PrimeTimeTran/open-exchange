...
import { articleCreateController } from 'src/features/article/controllers/articleCreateController';
...
describe('articleCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await articleCreateController(body, await testContext());
      fail();
    } catch (error) {
