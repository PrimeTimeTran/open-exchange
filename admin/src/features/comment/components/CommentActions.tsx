...
import { commentDestroyManyApiCall, commentArchiveManyApiCall, commentRestoreManyApiCall } from 'src/features/comment/commentApiCalls';
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[160px]">
          ...
          {mode === 'table' && hasPermissionToEdit && (
            <DropdownMenuItem asChild>
              <Link href={`/comment/${comment.id}/edit`} prefetch={false}>
