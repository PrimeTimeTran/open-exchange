...
import { ledgerEntryUpdateController } from 'src/features/ledgerEntry/controllers/ledgerEntryUpdateController';
...
describe('ledgerEntryUpdate', () => {
  ...
  it.skip('must be signed in', async () => {
    ...
    try {
      await ledgerEntryUpdateController(
        { id: ledgerEntry.id },
        {},
        await testContext(),
      );
  ...
  //     const previousLedgerEntry = await createLedgerEntry(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     const updatedLedgerEntry = await prisma.ledgerEntry.findUniqueOrThrow({
  //       where: { id: previousLedgerEntry?.id },
  //       include: {},
  //     });
