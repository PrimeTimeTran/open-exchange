...
import { assetImporterController } from 'src/features/asset/controllers/assetImporterController';
...
async function buildAsset(context: AppContext) {
...
describe('assetImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await assetImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await assetImporterController(
